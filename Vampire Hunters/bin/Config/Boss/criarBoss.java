...
public class criarBoss {
    ...
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Nome do boss: " + nomePersonagem);
            ...
            String confirmacao = "";
            while (true) {
                System.out.print("\nTem certeza de que deseja criar esse boss? (S/N): ");
                confirmacao = scanner.next();

                if (confirmacao.equalsIgnoreCase("S")) {
                    String nomeDoArquivo = "bin\\assets\\Enemies\\Boss\\" + nomeArquivo + ".java";
                    FileWriter fileWriter = new FileWriter(nomeDoArquivo);
                    BufferedWriter writer = new BufferedWriter(fileWriter);

                    writer.write("package bin.assets.Enemies.Boss;\n");
    ...
    private static boolean arquivoExiste(String nomeArquivo) {
        File file = new File("bin\\assets\\Enemies\\Boss\\" + nomeArquivo + ".java");
        return file.exists();
    }
}
