...
public class apagarMonsters {
    private static Scanner scanner = new Scanner(System.in);

    public static void main(String[] args) {
        File pasta = new File("bin\\assets\\Enemies\\Monsters");
        ...
        if (pasta.exists() && pasta.isDirectory()) {
            ...
            if (arquivos != null && arquivos.length > 0) {
                ...
                int numero = -1; // Inicialize com um valor inválido
                while (numero < 0 || numero > arquivos.length) {
                    ...
                    if (scanner.hasNextInt()) {
                        ...
                        if (numero < 0 || numero > arquivos.length) {
                            ...
                            exibirListaBosses(arquivos); // Exibe a lista novamente
                        }
                    } else {
