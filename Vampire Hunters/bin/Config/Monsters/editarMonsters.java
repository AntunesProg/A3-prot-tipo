...
public class editarMonsters {
    private static Scanner scanner = new Scanner(System.in);

    public static void main(String[] args) {
        File pastaMonstros = new File("bin/assets/Enemies/Monsters");
        ...
        System.out.println("Monstros disponíveis para edição:");
        ...
        System.out.print("Escolha o número do monstro que deseja editar: ");
        ...
        String filePath = "bin/assets/Enemies/Monsters/" + nomeArquivo + ".java";
